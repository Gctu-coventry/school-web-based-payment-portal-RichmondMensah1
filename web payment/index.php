...
<head>
    ...
    <title>School Payments System</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">School Payment System</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="copyright text-muted small">Copyright &copy; Coventry Uninversity 2022. All Rights Reserved</p>
                </div>
            </div>
        </div>
    </footer>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="copyright text-muted small">Copyright &copy; Coventry University 2014. All Rights Reserved</p>
                </div>
            </div>
        </div>
    </footer>
